...
if(!fs.existsSync('private.key')) {
    ...
    throw Error('对不起，没有找到private.key，请前往https://developers.weixin.qq.com/miniprogram/dev/devtools/ci.html查看文档');
}

if (!appid) {
    // console.log('对不起，appid不能为空，请前往./project.config.json查看');
    throw Error('对不起，appid不能为空，请前往./project.config.json查看');
}
